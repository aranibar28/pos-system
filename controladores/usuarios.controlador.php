   ...
   public static function ctrCrearUsuario()
   {
      if (isset($_POST["nuevoUsuario"])) {
         if (preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoNombre"]) && preg_match('/^[a-zA-Z0-9]+$/', $_POST["nuevoUsuario"]) && preg_match('/^[a-zA-Z0-9]+$/', $_POST["nuevoPassword"])) {
            ...
            $datos = ["nombre" => $_POST["nuevoNombre"], 
      ...
      if (isset($_POST["editarUsuario"])) {
        ...
        =============================================*/
          ...
          =============================================*/
            ...
            $datos = ["nombre" => $_POST["editarNombre"], "usuario" => $_POST["editarUsuario"],  "email" => $_POST["editarEmail"],"password" => $encriptar, "perfil" => $_POST["editarPerfil"], "foto" => $ruta];
  ...
  =============================================*/
   ...
   public static function ctrBorrarUsuario()
   {
      if (isset($_GET["idUsuario"])) {
         ...
         if ($_GET["fotoUsuario"] != "" && $_GET["fotoUsuario"] != "vistas/img/usuarios/default/anonymous.png") {
