  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary mb1 bg-purple" data-toggle="modal" data-target="#modalAgregarCliente">
          
          <i class="fa fa-plus-circle"></i>&nbsp&nbspAgregar Cliente
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        <?php
          ...
          foreach ($clientes as $key => $value) {
            ...
            $nacimiento = date("d/m/Y", strtotime($value["fecha_nacimiento"]));
