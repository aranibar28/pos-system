  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary mb1 bg-purple" data-toggle="modal" data-target="#modalAgregarProducto">
         
         <i class="fa fa-plus-circle"></i>&nbsp&nbspAgregar Producto
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <div class="form-group col-md-9"><input type="file" class="nuevaImagen" name="nuevaImagen">

              <p class="help-block">Peso máximo de la imagen 2MB</p></div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary mb1 bg-purple"><i class="fa fa-save"></i>&nbsp&nbspGuardar Producto</button>
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <div class="form-group col-md-9"><input type="file" class="nuevaImagen" name="editarImagen">
