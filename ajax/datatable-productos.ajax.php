    	...
    	$orden = "id";
		  ...
		  for($i = 0; $i < count($productos); $i++){
  			...
  			if($productos[$i]["stock"] < 10){
  				...
  				$stock = "<button class='btn btn-danger btn-flat'>0".$productos[$i]["stock"]."</button>";

  			}else if($productos[$i]["stock"] >=10 && $productos[$i]["stock"] <= 15){

  				$stock = "<button class='btn btn-warning btn-flat'>".$productos[$i]["stock"]."</button>";

  			}else{

  				$stock = "<button class='btn btn-success btn-flat'>".$productos[$i]["stock"]."</button>";
